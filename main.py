...
def info(message):
    bot.send_message(message.chat.id,
                     ...
                     /skills - добавление названий навыков в проект
                     
                     /projects - показывает все имеющиеся проекты
                     
                     /delete - удаление имеющегося проекта
                     
                     /update_projects - изменение/обновление данных проекта 
...
# команда отвесает за создание нового проекта вместе со всеми данными в бд
...
#добавление навыков для определенного проета в бд
...
#выводит список всех существующих проектов
...
# обновление данных существующиего проекта
...
#если пользователь ввел два раза неправильные/странные данные, бот отправляет инфо о доступных командах (?)
